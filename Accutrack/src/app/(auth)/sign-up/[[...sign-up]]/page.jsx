            ...
            <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
                ...
                <main className="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
                    <div className="max-w-xl lg:max-w-3xl">
                        ...
                        {/* Sign-Up Form */}
                        <div className="sign-up-container mt-6">
                            <SignUp
                                afterSignUpUrl="/dashboard" // Redirect after signing up
                                afterSignInUrl="/dashboard" // Just in case user is already signed in
                                signInUrl="/sign-in" 
                                appearance={{
                                    layout: {
                                    ...
                                    elements: {
                                        ...
                                        formButtonPrimary: "bg-black hover:bg-gray-700 text-white font-bold py-2 px-4 rounded",
